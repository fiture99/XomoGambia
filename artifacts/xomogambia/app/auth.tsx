...
export default function AuthScreen() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      await login(name.trim() || email.split("@")[0], email.trim(), role);
      if (isRegister && role === "provider") {
        ...
        >
          ...
          <View style={styles.roleCards}>
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <View style={[styles.roleIconBox, { backgroundColor: role === "customer" ? colors.primary : colors.secondary }]}>
                <Feather name="briefcase" size={26} color={role === "customer" ? "#fff" : colors.mutedForeground} />
              </View>
              <Text style={[styles.roleTitle, { color: colors.foreground }]}>Client / Customer</Text>
              <Text style={[styles.roleDesc, { color: colors.mutedForeground }]}>
                Browse verified companies, request quotes, and book services for your business or property.
              </Text>
              {role === "customer" && (
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <View style={[styles.roleIconBox, { backgroundColor: role === "provider" ? colors.accent : colors.secondary }]}>
                <Feather name="tool" size={26} color={role === "provider" ? "#fff" : colors.mutedForeground} />
              </View>
              <Text style={[styles.roleTitle, { color: colors.foreground }]}>Service Provider</Text>
              <Text style={[styles.roleDesc, { color: colors.mutedForeground }]}>
                Register your company, get verified, and receive job requests from hotels, offices and NGOs.
              </Text>
              {role === "provider" && (
          ...
          <TouchableOpacity
            style={[styles.continueBtn, { backgroundColor: role === "provider" ? colors.accent : colors.primary }]}
            onPress={() => {
              Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
              setStep("details");
            }}
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity
            style={[
              styles.submitBtn,
              {
                backgroundColor: isRegister && role === "provider" ? colors.accent : colors.primary,
